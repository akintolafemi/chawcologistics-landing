...
<head>
    ...
    <title>Chawcologistics &#8211; Contact Us</title>
...
<body>
    ...
    <div class="page">
        ...
        <div class="main-site">
                    ...
                    <div class="row"><!--row-->
                        <div class="col-lg-6 col-md-12 col-sm-12 pr-140">
                            ...
                            <div class="pt-30">
                                ...
                                <div class="text-left">
                                    <h3 class="fs-24">Ibadan, Nigeria (HQ)</h3>
                                    <ul class="cmt-box-desc-text fs_16">
                                        <li><strong>Address:</strong>Address here....</li>
                                        <li><strong>Call Us On:</strong>Phone here...</li>
                                        <li><strong>Mail Us:</strong> info@chawcologistics.com</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="pt-30">
                                <div class="mb-20">
                                    <img class="img-fluid" src="../images/single-img-08.png" alt="single-img-08">
                                </div>
                                <div class="text-left">
                                    <h3 class="fs-24">Lagos</h3>
                                    <ul class="cmt-box-desc-text fs_16">
                                        <li><strong>Address:</strong>Address here....</li>
                                        <li><strong>Call Us On:</strong>Phone here...</li>
                                        <li><strong>Mail Us:</strong> info@chawcologistics.com</li>
                            ...
                            <div class="z-index-0 res-991-mb-30">
                                <a class="submit cmt-btn cmt-btn-size-md cmt-btn-shape-square cmt-btn-style-fill cmt-icon-btn-left cmt-btn-color-skincolor" href="https://www.google.com/maps/place/Iwo+Road,+Ibadan/@7.4036643,3.9306592,15z/data=!3m1!4b1!4m5!3m4!1s0x103992dc3d5f95bd:0x28b52676dc7a7f6!8m2!3d7.4018738!4d3.9393926" target="_blank"><i class="ti ti-map-alt"></i> Get Direction On The Map!
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="cmt-bgcolor-white box-shadow cmt-contactform-style3 position-sticky spacing-11">
                                ...
                                <form id="cmt-contactform-3" class="cmt-contactform-3 wrap-form clearfix" method="post" action="#">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label>
                                                        ...
                                                        <span class="text-input"><input name="name" type="text" value="" placeholder="Business Name" required="required"></span>
                                                    </label>
                                                </div>
                                                <div class="col-12">
                                                    <label>
                                                ...
                                                <div class="col-12">
                                                    <label>
                                                        ...
                                                        <span class="text-input">
                                                            <select aria-required="true" aria-invalid="false" aria-hidden="true">
            ...
            <section class="cmt-row cmt-bgimage-yes bg-img13 cmt-bg  clearfix">
                <div class="cmt-row-wrapper-bg-layer cmt-bg-layer"></div>
                <div class="container"><!--container-->
                    <div class="row"><!--row-->
                        <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                            <div>
                                <h3 class="fs-26 cmt-textcolor-white">Modern Logistic Company</h3>
                                <h2 class="fs-47 cmt-textcolor-white">Make Faster Delivery In A Quick Solution</h2>
                            </div>
                            <div class="d-sm-flex justify-content-center">
                                <div class="featured-icon-box icon-align-before-content style9 border-right">
                                ...
                                <div class="featured-icon-box icon-align-before-content style9 res-575-pl-0">
                                    <div class="featured-icon">
                                       <div class="cmt-icon cmt-icon_element-size-lg cmt-icon_element-onlytxt cmt-icon_element-color-skincolor">
            ...
            <section class="cmt-row cmt-bgcolor-grey clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 res-767-mb-25">
                            <div class="pr-35 res-767-mb-25 res-767-pr-0">
                                <h3>Careers</h3>
                                <div class="mt-15 mb-15">
                                </div>
                                <a href="#" class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-color-dark fs_16 font-weight-500">
                                    See open positions<i class="fa fa-arrow-right fs_15 mb-1"></i>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12  res-767-mb-25">
                            <div class="pr-35 res-767-mb-25 res-767-pr-0">
                                ...
                                <a href="#" class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-color-dark fs_16 font-weight-500"> See Customer Stories<i class="fa fa-arrow-right fs_15 mb-1"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 res-767-mb-25">
                            <div class="pr-35 res-767-mb-25 res-767-pr-0">
                                ...
                                <a href="#" class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-color-dark fs_16 font-weight-500"> Get Quotation<i class="fa fa-arrow-right fs_15 mb-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
